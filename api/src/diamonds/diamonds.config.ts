export interface DiamondColumnEntry {
  columnIndex: number;
  key: string;
}

export const DIAMOND_COLUMN_MAP: readonly DiamondColumnEntry[] = Object.freeze([
...
export const DIAMOND_RESPONSE_GROUPS: Readonly<Record<string, readonly string[]>> = Object.freeze({
  media: ['image', 'video'],
...
export const SCALE: Readonly<Record<string, readonly string[]>> = Object.freeze({
...
export const FRONTEND_SCALE_MAP: Readonly<Record<string, Readonly<Record<string, string>>>> = Object.freeze({
  cut: Object.freeze({
    FAIR: 'F',
    GOOD: 'G',
    'VERY GOOD': 'VG',
